...
export class MatchEffects {
  ...
  updateMatchResult$ = createEffect(() =>
    this.actions$.pipe(
      ofType(MatchActions.updateMatchResult),
      switchMap(({ matchId, result }) =>
        this.matchService.updateMatchResult(matchId, result).pipe(
  ...
  updateMatchResultError$ = createEffect(
    () =>
      this.actions$.pipe(
  ...
  finishMatch = createEffect(() =>
    this.actions$.pipe(
      ofType(MatchActions.finishMatch),
      switchMap(({ matchId, result }) =>
        this.matchService.finishMatch(matchId, result).pipe(
  ...
  startMatch = createEffect(() =>
    this.actions$.pipe(
      ...
      switchMap(({ tableId, matchId }) =>
        this.matchService.startMatch(tableId, matchId).pipe(
  ...
  callPlayerForMatch = createEffect(() =>
    this.actions$.pipe(
      ofType(MatchActions.callPlayerForMatch),
      switchMap(({ playerIds, matchId }) =>
        this.matchService.callPlayersForMatch(playerIds, matchId).pipe(
  ...
  callPlayerForMatchError$ = createEffect(
    () =>
      this.actions$.pipe(
  ...
  takeBackMatch$ = createEffect(() =>
    this.actions$.pipe(
      ofType(MatchActions.takeBackMatch),
      switchMap(({ matchId }) =>
        this.matchService.takeBackMatch(matchId).pipe(
  ...
  takeBackMatchError$ = createEffect(
    () =>
      this.actions$.pipe(
